...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = app_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=app_config.TENCENT_COS_REGION,
            SecretId=app_config.TENCENT_COS_SECRET_ID,
            SecretKey=app_config.TENCENT_COS_SECRET_KEY,
            Scheme=app_config.TENCENT_COS_SCHEME,
        )
