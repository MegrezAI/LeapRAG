...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = app_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=app_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=app_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=app_config.VOLCENGINE_TOS_ENDPOINT,
            region=app_config.VOLCENGINE_TOS_REGION,
        )
