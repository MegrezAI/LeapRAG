...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = app_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=app_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=app_config.HUAWEI_OBS_SECRET_KEY,
            server=app_config.HUAWEI_OBS_SERVER,
        )
