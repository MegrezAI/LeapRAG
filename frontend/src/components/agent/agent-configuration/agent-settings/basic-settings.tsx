...
export function BasicSettings({ isPending = false, knowledgeBases = [] }: BasicSettingsProps) {
  ...
  return (
    <div className="space-y-6 px-1">
      <FormField
        control={control}
        name="agent_config.dialog_config.language"
        render={({ field }) => (
          <FormItem>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={control}
            name="agent_config.dialog_config.top_n"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="agent_config.dialog_config.similarity_threshold"
            render={({ field }) => (
              <FormItem>
                <FormLabel>
