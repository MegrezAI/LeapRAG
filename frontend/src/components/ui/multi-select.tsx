...
export const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    ...
    const placeholderText = t('Select Options');

    React.useEffect(() => {
      if (!defaultValue || isEqual(defaultValue, selectedValues)) return;
          ...
          >
            {selectedValues.length > 0 ? (
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-sm text-muted-foreground mx-3">{placeholderText}</span>
